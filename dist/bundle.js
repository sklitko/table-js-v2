...
var Table = function () {
    function Table(data) {
        ...
        this.sort_t.addEventListener('click', function () {
            return _this.sort();
        }, false);
    }
    ...
    _createClass(Table, [{
        ...
        value: function show() {
            ...
            this.summ.innerHTML = "";
            this.data.forEach(function (item, arr) {
                var tr = document.createElement('tr');
                item.summ = item.count * item.price;
                _this2.summ.innerText = +document.querySelector('.summ').innerText + item.summ;
                for (var index in item) {
                    var td = document.createElement('td');
                    td.innerText = item[index];
                    tr.appendChild(td);
                }
                _this2.table.appendChild(tr);
            });
        }
    }, {
        key: 'sort',
        value: function sort() {
            ...
            if (this.flag) {
                ...
                this.show();
                this.flag = false;
                var strelka = document.createTextNode(String.fromCharCode(8659));
                ...
                this.show();
                this.flag = true;
                var _strelka = document.createTextNode(String.fromCharCode(8657));
                span.appendChild(_strelka);
                this.sort_t.appendChild(span);
            }
        }
    }]);
...
var table = new _Table2.default(data);
table.show();
//table.sort();
